...
def smote(
    ...
    for regression of SMOTE method, which applies over-sampling the minority 
    ...
    'smote' represents Synthetic Minority Over-sampling TEchnique and 
    oversamples the minority class.
    
    'smote' is only applied to numeric / continuous features, synthetic values 
    ...
    frame containing over-sampled (synthetic) observations, 
